...
// Load from video-player-lite-changelog.html in the assets folder
            ...
            InputStream json = getContext().getApplicationContext().getAssets().open("video-player-lite-changelog.html");
            ...
            webView.loadData(buf.toString()
                    ...
                    .replace("{link-color}", colorToHex(Color.parseColor("#FF4081")))
