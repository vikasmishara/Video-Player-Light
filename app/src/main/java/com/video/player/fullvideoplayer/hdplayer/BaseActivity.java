...
import com.video.player.fullvideoplayer.hdplayer.fragment.MyFragment;
...
import com.video.player.fullvideoplayer.hdplayer.permission.PermissionCallback;
...
public abstract class BaseActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(theme== 9) {
            ...
            setTheme(R.style.AppThemeLightBasic10);

        }if(theme== 11) {
            setTheme(R.style.AppThemeLightBasic11);

        }if(theme== 12) {
            setTheme(R.style.AppThemeLightBasic12);

        }if(theme== 13) {
            setTheme(R.style.AppThemeLightBasic13);

        }if(theme== 14) {
            setTheme(R.style.AppThemeLightBasic14);

        }if(theme== 15) {
            setTheme(R.style.AppThemeLightBasic15);

        }if(theme== 16) {
            setTheme(R.style.AppThemeLightBasic16);

        }if(theme== 17) {
            setTheme(R.style.AppThemeLightBasic17);

        }if(theme== 18) {
            setTheme(R.style.AppThemeLightBasic18);

        }if(theme== 19) {
            setTheme(R.style.AppThemeLightBasic19);

        }if(theme== 20) {
            setTheme(R.style.AppThemeLightBasic20);
